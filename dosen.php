      ...
      <section class="py-5">
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            ...
            <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
            <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
            <lottie-player src="https://assets7.lottiefiles.com/private_files/lf30_JenNba.json"  background="transparent"  speed="1"  style="width: 600px; height: 500px;"  loop  autoplay></lottie-player>
          </div>
          <!--tulisan-->
          <div class="col-md-6 align-items-center">
          <div class="card text-center">  
            <div class="card-header">
            <lottie-player src="https://assets3.lottiefiles.com/packages/lf20_9evakyqx.json"  background="transparent"  speed="1"  style="width: 600px; height: 100px;"  loop  autoplay></lottie-player>
            </div>
            <div class="card-body">
